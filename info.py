...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5236678934').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002076134736').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Akshadgod:14643583pp@cluster0.nnyqicw.mongodb.net/?retryWrites=true&w=majority ")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001664838400'))
...
URL = "https://test-v7zi.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://test-v7zi.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://test-v7zi.onrender.com".format(FQDN)
else:
    URL = "https://test-v7zi.onrender.com".format(FQDN)
